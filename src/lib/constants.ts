...
export const APP_NAME = "InsureWright MVP Vision";
export const APP_DESCRIPTION =
  "Product definition portal — capture the decisions that shape InsureWright as a sellable SaaS platform for MGAs in UK and Ireland";
