      ...
      <div className="flex-1 p-6 space-y-6 overflow-y-auto">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Help us define InsureWright as a product. Your MGA expertise shapes
            what we build, who we sell to, and how we win. Answer each decision
            below and confirm when you&apos;re satisfied.
          </p>
        </div>
