...
export const metadata: Metadata = {
  title: "InsureWright MVP Vision — Product Definition Portal",
  description:
    "InsureWright MVP Vision product definition portal. Capture the decisions that shape InsureWright as a sellable SaaS platform for MGAs in UK and Ireland.",
};
